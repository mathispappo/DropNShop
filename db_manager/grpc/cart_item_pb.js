...
goog.exportSymbol('proto.dropnshop.UpsertCartItemRequest', null, global);
/**
 ...
 * @constructor
 */
proto.dropnshop.UpsertCartItemRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dropnshop.UpsertCartItemRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.dropnshop.UpsertCartItemRequest.displayName = 'proto.dropnshop.UpsertCartItemRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 */
proto.dropnshop.CartItem.prototype.getItem = function() {
  return /** @type{?proto.dropnshop.Item} */ (
    jspb.Message.getWrapperField(this, item_pb.Item, 3));
};
 ...
 * @return {!proto.dropnshop.CartItem} returns this
*/
proto.dropnshop.CartItem.prototype.setItem = function(value) {
 ...
 * @return {!proto.dropnshop.CartItem} returns this
 */
proto.dropnshop.CartItem.prototype.clearItem = function() {
 ...
 * @return {boolean}
 */
proto.dropnshop.CartItem.prototype.hasItem = function() {
 ...
 * @return {!Object}
 */
proto.dropnshop.UpsertCartItemRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.dropnshop.UpsertCartItemRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dropnshop.UpsertCartItemRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dropnshop.UpsertCartItemRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dropnshop.UpsertCartItemRequest}
 */
proto.dropnshop.UpsertCartItemRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dropnshop.UpsertCartItemRequest;
  return proto.dropnshop.UpsertCartItemRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dropnshop.UpsertCartItemRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dropnshop.UpsertCartItemRequest}
 */
proto.dropnshop.UpsertCartItemRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.dropnshop.UpsertCartItemRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dropnshop.UpsertCartItemRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dropnshop.UpsertCartItemRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dropnshop.UpsertCartItemRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserid();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.dropnshop.UpsertCartItemRequest.prototype.getUserid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.dropnshop.UpsertCartItemRequest} returns this
 */
proto.dropnshop.UpsertCartItemRequest.prototype.setUserid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.dropnshop.UpsertCartItemRequest.prototype.getItemid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.dropnshop.UpsertCartItemRequest} returns this
 */
proto.dropnshop.UpsertCartItemRequest.prototype.setItemid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.dropnshop.UpsertCartItemRequest.prototype.getQuantity = function() {
 ...
 * @return {!proto.dropnshop.UpsertCartItemRequest} returns this
 */
proto.dropnshop.UpsertCartItemRequest.prototype.setQuantity = function(value) {
 ...
 * @return {number}
 */
proto.dropnshop.DeleteCartItemRequest.prototype.getUserid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.dropnshop.DeleteCartItemRequest} returns this
 */
proto.dropnshop.DeleteCartItemRequest.prototype.setUserid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
